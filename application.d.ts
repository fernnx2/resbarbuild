...
declare const ResbarApirest2020Application_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
...
export declare class ResbarApirest2020Application extends ResbarApirest2020Application_base {
